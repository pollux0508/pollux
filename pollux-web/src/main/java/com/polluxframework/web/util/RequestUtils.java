package com.polluxframework.web.util;
...
public class RequestUtils {
	...
	public static Boolean isAjaxRequest(HttpServletRequest request) {
		//优先判断请求头是否是json头判断
		boolean flag = (request.getHeader(ACCEPT) != null && request.getHeader(ACCEPT).contains(JSON_ACCEPT)) || JSON_REQUEST_VAL.equals(request.getHeader(JSON_REQUEST_HEADER));
		if (flag) {
			return true;
		}
