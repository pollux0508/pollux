...
public class LoginFilter implements Filter {
	...
	private void filterRedirect(HttpServletRequest request, HttpServletResponse response) throws IOException {
		if (RequestUtils.isAjaxRequest(request)) {
			...
			WebResponse webResponse = WebResponse.error(WebConstant.NOT_LOGGED_CODE, WebConstant.NOT_LOGGED_MESSAGE);
			ObjectMapper mapper = new ObjectMapper();
			String massage = mapper.writeValueAsString(webResponse);
